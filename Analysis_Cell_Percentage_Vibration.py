...
conditions = ["Control", "20 min Vib.", "60 min Vib."]
...
def create_data():
    ...
    for i in range(len(df)):
        ...
        elif "Vibration_1h" in name[i]:
            data[2].append("60 min Vib.")
        elif "1h_Vibration" in name[i]:
            data[2].append("60 min Vib.")
        elif "20min" in name[i]:
            data[2].append("20 min Vib.")
...
def plot_bars_FUS():
    ...
    for i in range(len(mutants)):
        ...
        axs[i].bar(position, mean_percent_FUS[count:count+len(conditions)], yerr=std_FUS[count:count+len(conditions)], width=w, capsize=8, tick_label=labels[count:count+len(conditions)], color = ["c", "orange", "r"]) 
...
def plot_bars_G3BP():
    ...
    for i in range(len(mutants)):
        ...
        axs[i].bar(position, mean_percent_G3BP[count:count+len(conditions)], yerr=std_G3BP[count:count+len(conditions)], width=w, capsize=8, tick_label=labels[count:count+len(conditions)], color = ["c", "orange", "r"]) 
...
def plot_bars_both():
    ...
    for i in range(len(mutants)):
        ...
        axs[i].bar(position, mean_percent_both[count:count+len(conditions)], yerr=std_both[count:count+len(conditions)], width=w, capsize=8, tick_label=labels[count:count+len(conditions)], color = ["c", "orange", "r"]) 
