...
def create_data():
    ...
    for i in range(len(name)):
        ...
        if area[i] < cutoff_area and mean[i] > cutoff_intensity and intDen[i] > cutoff_intDen:
            ...
            # append dataset
            if "220119" in name[i] or "220120" in name[i]: 
                data[5].append("0")
            elif "sample1" in name[i]: 
                data[5].append("1")
            elif "sample2" in name[i]:    
                data[5].append("2")   
...
#stat_test(test="t", alpha=0.05, parameter="intDen")
...
norm_stat_test(test="t", alpha=0.05, parameter="intensity")
...
def plot_violinplots_intensity():
    ...
    fig.suptitle("GGGGG: Mean Particle Intensity")
...
def plot_violinplots_area():
    ...
    fig, axs = plt.subplots(1,3, sharey=True)
    fig.suptitle("GGGGG: Particle Area")
...
def plot_dataset_boxplots_intensity(to_plot):
    ...
    fig, axs = plt.subplots (1,3, sharey=True)    
    fig.suptitle("GGGGG: Mean Particle Intensity, Dataset " + to_plot)
    axs[0].set_ylabel("Mean Intensity [a.u.]")
    #axs[0].set_ylim(-1.2,1.5)
...
def plot_normalized_intensities():
    ...
    fig, axs = plt.subplots (1,3, sharey=True)    
    fig.suptitle("GGGGG: Normalized Mean Particle Intensity")
...
def plot_normalized_area():
    ...
    fig, axs = plt.subplots (1,3, sharey=True)    
    fig.suptitle("GGGGG: Normalized Area")
...
def plot_boxplots_intDen():
    ...
    fig, axs = plt.subplots (1,3, sharey=True)    
    fig.suptitle("GGGGG: Particle Integrated Density")
...
def plot_normalized_intDen_no_wt():
    ...
    fig, axs = plt.subplots (1,2, sharey=True)    
    fig.suptitle("GGGGG: Normalized intDen")
...
def scatter_plots():
    ...
    fig.suptitle("GGGGG: Mean Intensity vs. Area")
...
def plot_normalized_intensities2():
    ...
    fig, axs = plt.subplots (1,3, sharey=True)    
    fig.suptitle("GGGGG: Normalized Mean Particle Intensity (ea Dataset)")
    axs[0].set_ylabel("Normalized Mean Intensity")
...
def plot_normalized_intDen2():
    ...
    fig, axs = plt.subplots (1,3, sharey=True)    
    fig.suptitle("GGGGG: Normalized intDen (ea Dataset)")
    axs[0].set_ylabel("Normalized intDen")
    axs[0].set_ylim(-0.1,4)
...
def plot_normalized_area2():
    ...
    fig, axs = plt.subplots (1,3, sharey=True)    
    fig.suptitle("GGGGG: Normalized Area (ea Dataset)")
    axs[0].set_ylabel("Normalized Area")
    axs[0].set_ylim(-0.1,4)
